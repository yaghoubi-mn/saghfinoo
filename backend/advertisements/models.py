...
class AdvertisementChoice(models.Model):
    ...
    def add_default_rows(cls):
        default = (
            ...
            ('typeOfRestroom', 'فرنگی', 'farhangi'),
            ('typeOfRestroom', 'ایرانی', 'irani'),
            ('coolingSystem', 'کولر آبی', 'water cooler'),
            ('coolingSystem', 'چیلر', 'chiller'),
            ('coolingSystem', 'اسپلیت', 'split'),
            ('coolingSystem', 'فن کوئل', 'fan koel'),
            ('heatingSystem', 'شومینه', 'fireplace'),
            ('heatingSystem', 'اسپلیت', 'split'),
            ('heatingSystem', 'مرکزی', 'centeral'),
            ('heatingSystem', 'از کف', 'in-floor'),
            ('heatingSystem', 'رادیاتور', 'radiator'),
